...
class CertificateParameters(BaseModel):
    ...
    RollNumber: str = Field(..., description='Roll Number', examples=['7894567860'])
    Session: str = Field(
        ...,
        description='Academic session',
        examples=['Aug 2013,Aug 2014,Aug 2015,Aug 2016,Aug 2017'],
    )
...
class CertificateParameters1(BaseModel):
    ...
    FullName: str = Field(..., description='Full name', examples=['Sunil Kumar'])
    RollNumber: str = Field(..., description='Roll Number', examples=['07275499643'])
    Sem: str = Field(..., description='Semester', examples=['1,2,3,4,Consolidated'])
    Session: str = Field(
        ...,
        description='Academic session',
        examples=['Aug 2013,Aug 2014,Aug 2015,Aug 2016,Aug 2017'],
